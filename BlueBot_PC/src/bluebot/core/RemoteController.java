...
public class RemoteController implements Controller {
	...
	public void moveBackward() {
		sendPacket(getPacketFactory().createMove(2));
	}
	
	public void moveForward() {
		sendPacket(getPacketFactory().createMove(8));
	}
	...
	public void turnLeft() {
		sendPacket(getPacketFactory().createMove(4));
	}
	
	public void turnRight() {
		sendPacket(getPacketFactory().createMove(6));
	}
