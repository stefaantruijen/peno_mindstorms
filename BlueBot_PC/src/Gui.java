    ...
    //Keyboard action
       ...
       {
          try {
             if(ke.getKeyChar() == 'z')outData.writeInt(1);
              if(ke.getKeyChar() == 's')outData.writeInt(2);
             if(ke.getKeyChar() == 'q')outData.writeInt(3);
       ...
       {
           try {
              if(ke.getKeyChar() == 'z'){outData.writeInt(10);}
              if(ke.getKeyChar() == 's'){outData.writeInt(20);}
              if(ke.getKeyChar() == 'q'){outData.writeInt(30);}
